...
public class FragmentAdviceOthers extends Fragment
{
    ...
    {
        super.onStart();
        //Toast.makeText(getActivity(), "Start=> OTHERS", Toast.LENGTH_SHORT).show();
        m_IsStarted = true;
//        if (m_IsViewShown){
//            //updateOptionsMenu();
//        }
    ...
    {
        super.onResume();
        //Toast.makeText(getActivity(), "Resume=> OTHERS", Toast.LENGTH_SHORT).show();
        //updateOptionsMenu();
        if(mAdapter != null)
        {
...
//        if (getView() != null) {
//            m_IsViewShown = true;
//            Toast.makeText(getActivity(), "Hint=> OTHERS", Toast.LENGTH_SHORT).show();
//            updateOptionsMenu();
//        } else {
//            m_IsViewShown = false;
//        }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState)
    {
        ...
        //Toast.makeText(getActivity(), "Create=> OTHERS", Toast.LENGTH_SHORT).show();
        if(m_IsViewShown)
        {
            updateOptionsMenu();
        }
...
//        m_SearchBar.hideSuggestionsList();
    ...
    {
//        if(!m_IsViewShown) {
//            Toast.makeText(getActivity(), "View=> OTHERS", Toast.LENGTH_SHORT).show();
//            updateOptionsMenu();
//        }
